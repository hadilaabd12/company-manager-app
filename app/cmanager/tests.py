...
class WarrangementTest(TestCase):
    ...
    def create_wa(self, type='40'):
        return WorkArrangement.objects.create(type=type, created_at=timezone.now())
...
class EmployeeTest(TestCase):
    ...
    def create_employee(self, name="Employee 1", hourly_rate= 10):
        return Employee.objects.create(name=name, hourly_rate=hourly_rate, created_at=timezone.now())
